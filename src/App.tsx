...
import FindSuppliersModal from "./components/FindSuppliersModal";
...
const App: React.FC<DashboardProps> = ({ sidebarCollapsed }) => {
      ...
      <div className="mb-4 sm:mb-6 lg:mb-8">
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
            <h2 className="text-sm font-semibold text-gray-900 mb-2 sm:mb-0">
              Live RFQ Metrics
            </h2>
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
              <Calendar
                size={12}
                className="text-primary-600 hidden sm:block"
              />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {kpiData.map((kpi, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-primary-50 to-purple-50 p-3 rounded-lg border border-primary-100 hover:shadow-md transition-all duration-300"
              >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <div className="space-y-2">
            {suppliers.slice(0, 8).map((supplier, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-2 hover:bg-primary-50 rounded-md transition-all duration-200 border border-transparent hover:border-primary-100"
              >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <div className="space-y-3">
            {quotations.slice(0, 5).map((quotation, index) => (
              <div
                key={index}
                className="border-b border-gray-100 pb-3 last:border-b-0 last:pb-0 hover:bg-primary-50 p-2 rounded-md transition-all duration-200"
              >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <div className="space-y-3">
            {alerts.map((alert, index) => (
              <div
                key={index}
                className={`flex items-start space-x-2 p-2 rounded-md border transition-all duration-200 ${
                  alert.unread
